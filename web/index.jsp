...
<div id="myModal" class="tranloan-modal">
    <a href="http://faceseo.vn" target="_blank" img src="http://2.bp.blogspot.com/-eLSsK_4fUzg/Uk9dEo40_4I/AAAAAAAABfM/LcB3n6svA_s/s1600/popup-faceseo.jpg" ></a>
    <a class="close-tranloan-modal"></a>
</div>
<link rel="stylesheet" href="assets/css/tranloan.css"/>
...
<script type="text/javascript">
    ...
    jQuery(window).load(function() {
        if(document.cookie.indexOf("adf") == -1)
        {
            ...
            jQuery('#myModal').tranloan($('#myModal').data());
        }
    });
</script>
