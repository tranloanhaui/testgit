            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="fa fa-id-cusd-o"></i><a href="ui-cusds.jsp">cusds</a></li>
                        <li><i class="fa fa-exclamation-triangle"></i><a href="ui-alerts.jsp">Alerts</a></li>
                ...
                <li class="menu-item-has-children active dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Tables</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="tables-data.jsp">Data Table cus</a></li>
    ...
    <div class="content mt-3">
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-md-12">
                    <div class="cusd">
                        <div class="cusd-header">
                            <strong class="cusd-title">Data Table</strong>
                        </div>
                        <div class="cusd-body">
                            <div style="margin-bottom: 10px;">
                                <%--                                    <a type="button" class="btn btn_add btn-primary" href="/cus?Actioncus=addcus">addcus</a></div>--%>
                                <a title="Thêm" href="/Customer?Actioncus=addcustomer"><i class="fa fa-plus-square"></i></a>
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <%
                                        ...
                                        for (Customer cus : mc.getCustomerList()) {
                                    %>
                                    <tr>
                                        <c:set var="count" value="${count+1}"></c:set>
                                        <td>${count}</td>
                                        <td><%=cus.getCustomer_name()%></td>
                                        <td><%=cus.getCustomer_fullname()%></td>
                                        <td><%=cus.getCustomer_phone()%></td>
                                        <td><%=cus.getCustomer_birthday()%></td>
                                        <td><%=cus.getCustomer_homephone()%></td>
                                        <td><%=cus.getCustomer_email()%></td>
                                        <td><%=cus.getCustomer_address()%></td>
                                        <td><%=cus.getCustomer_job()%></td>
                                        <td><%=cus.getCustomer_note()%></td>
                                        <td></td>
                                        <td>
                                            <div class="row">
                                                <%--                                                    <a class="col-md-6" style="width:10px;" type="button" class="btn btn-primary"--%>
                                                <%--                                                       href="/cus?Actioncus=update&numberplate=<%=cus.getNumberplate()%>">Edit</a>--%>
                                                <a title="Sửa" style="margin-left:25px;" href="/Customer?Actioncus=Updatecustomer&id=<%=cus.getCustomer_id()%>"><i class="fa fa-cog"></i></a>

                                                <%--                                                    <a class="col-md-6" type="button" class="btn btn-primary"--%>
                                                <%--                                                       href="/cus?Actioncus=tabledelete&numberplate=<%=cus.getNumberplate()%>">Delete</a>--%>
                                                <a title="Xóa" style="margin-left:10px;" href="/Customer?Actioncus=tablecustomerdelete&id=<%=cus.getCustomer_id()%>"><i class="fa fa-trash-o"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <% }%>
