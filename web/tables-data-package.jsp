...
<%--                                    <a type="button" class="btn btn_add btn-primary" href="/Car?Actioncar=addcar">addcar</a></div>--%>
                                        <a title="Thêm" href="/Package?Actionpackage=addpackage"><i class="fa fa-plus-square"></i></a>
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ...
                                            for (InsurancePackage insu : mp.getPackageList1()) {
                                        %>
                                        <tr>
                                            <c:set var="count" value="${count+1}"></c:set>
                                            <td>${count}</td>
                                            <td><%=insu.getPackagetype()%></td>
                                            <td><%=insu.getCartype()%></td>
                                            <td><%=insu.getIDinsurance()%></td>
                                            <td><%=insu.getTimelimit()%></td>
                                            <td><%=insu.getDateofissue()%></td>
                                            <td>
                                                <div class="row">
<%--                                                    <a class="col-md-6" style="width:10px;" type="button" class="btn btn-primary"--%>
<%--                                                       href="/Car?Actioncar=update&numberplate=<%=car.getNumberplate()%>">Edit</a>--%>
                                                    <a title="Sửa" style="margin-left:25px;" href="/Package?Actionpackage=Updatepackage&id=<%=insu.getIDinsurance()%>"><i class="fa fa-cog"></i></a>

<%--                                                    <a class="col-md-6" type="button" class="btn btn-primary"--%>
<%--                                                       href="/Car?Actioncar=tabledelete&numberplate=<%=car.getNumberplate()%>">Delete</a>--%>
                                                    <a title="Xóa" style="margin-left:10px;" href="/Package?Actionpackage=tablepackagedelete&id=<%=insu.getIDinsurance()%>"><i class="fa fa-trash-o"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <% }%>
