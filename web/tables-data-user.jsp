...
<%--                                    <a type="button" class="btn btn_add btn-primary" href="/Car?Actioncar=addcar">addcar</a></div>--%>
                                        <a title="Thêm" href="/User?Actionuser=adduser"><i class="fa fa-plus-square"></i></a>
                                </div>
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ...
                                            for (UserCar uc : um.getUserList()) {
                                        %>
                                        <tr>
                                            <c:set var="count" value="${count+1}"></c:set>
                                            <td>${count}</td>
                                            <td><%=uc.getUsername()%></td>
                                            <td><%=uc.getPassword()%></td>
                                            <td><%=uc.getUser_fullname()%></td>
                                            <td><%=uc.getEmail()%></td>
                                            <td><%=uc.getDate()%></td>
                                            <td><%=uc.getPhone()%></td>
                                            <td><%=uc.getNote()%></td>
                                            <td><%=uc.getUser_roles()%></td>
                                            <td><%=uc.getUser_id()%></td>
                                            <td>
                                                <div class="row">
...
<%--                                                       href="/Car?Actioncar=update&numberplate=<%=car.getNumberplate()%>">Edit</a>--%>
                                                    <a title="Sửa" style="margin-left:25px;" href="/User?Actionuser=Updateuser&id=<%=uc.getUser_id()%>"><i class="fa fa-cog"></i></a>

<%--                                                    <a class="col-md-6" type="button" class="btn btn-primary"--%>
<%--                                                       href="/Car?Actioncar=tabledelete&numberplate=<%=car.getNumberplate()%>">Delete</a>--%>
                                                    <a title="Xóa" style="margin-left:10px;" href="/User?Actionuser=tableuserdelete&id=<%=uc.getUser_id()%>"><i class="fa fa-trash-o"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <% }%>
