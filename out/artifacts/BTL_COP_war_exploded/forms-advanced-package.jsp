...
<%@ page import="Entities.InsurancePackage" %>
<!doctype html>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="WEB-INF"><img src="images/logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="WEB-INF"><img src="images/logo2.png" alt="Logo"></a>
            </div>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <%
                        InsurancePackage insu= new InsurancePackage();
                    %>
                    <form role="form"  action="/Package?Actionpackage=tablepackageadd" method="post">
                            ...
                            <div class="card" style="width: 700px; margin-left: 210px;">
                                ...
                                <div class="card-body card-block">
                                    <div class="form-group">
                                        <label class=" form-control-label">IDinsurance</label>
                                    ...
                                    <div class="form-group">
                                        <label class=" form-control-label">Packagetype</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                            <input class="form-control" type="text" name="txtpackagetype" >
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name="txtcartype" >
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-phone"></i></div>
                                            <input class="form-control" type="text" name="txtlimit" >
                                        </div>
                                        <small class="form-text text-muted">ex. 2 năm</small>
                                    </div>
                                    <div class="form-group">
                                        <label class=" form-control-label">Issue</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-phone"></i></div>
                                            <input class="form-control" type="text" name="txtissue" >
                                        </div>
