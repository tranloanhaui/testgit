...
<%--                                    <a type="button" class="btn btn_add btn-primary" href="/Car?Actioncar=addcar">addcar</a></div>--%>
                                        <a title="Thêm" href="/Car?Actioncar=addcar"><i class="fa fa-plus-square"></i></a>
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><%=car.getBrand()%></td>
                                            <td><%=car.getYearofmanufacture()%></td>
                                            <td><%=car.getPrice()%></td>
                                            <td><%=car.getTax()%></td>
                                            <td><%=car.isHaveinsurancecar()%></td>
                                            <td><%=car.getUsername()%></td>
                                            <td><%=car.getEngine()%></td>
                                            <td><%=car.getGear()%></td>
                                            <td><%=car.getFuel()%></td>
                                            <td><%=pr.tien(car.getPrice(),1)%></td>
                                            <td>
                                                <div class="row">
...
<%--                                                       href="/Car?Actioncar=update&numberplate=<%=car.getNumberplate()%>">Edit</a>--%>
                                                    <a title="Sửa" style="margin-left:25px;" href="/Car?Actioncar=Updatecar&numberplate=<%=car.getNumberplate()%>"><i class="fa fa-cog"></i></a>

<%--                                                    <a class="col-md-6" type="button" class="btn btn-primary"--%>
<%--                                                       href="/Car?Actioncar=tabledelete&numberplate=<%=car.getNumberplate()%>">Delete</a>--%>
                                                    <a title="Xóa" style="margin-left:10px;" href="/Car?Actioncar=tablecardelete&numberplate=<%=car.getNumberplate()%>"><i class="fa fa-trash-o"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <% }%>
